    ...
    return (
        <section id='contact' class="bg-neutral-950 xl:px-16 px-6 py-4">
            <div class="container px-6 py-12 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-12 mt-16 lg:grid-cols-2 items-center">
                    <div class="grid grid-cols-2 gap-12">
                        <div className='flex flex-col items-center'>
                            <span class="inline-block p-3 text-lime-500 rounded-full bg-lime-100/80 dark:bg-gray-800">
                            <FontAwesomeIcon icon="fa-brands fa-linkedin-in" style={{color: "#FFD43B",}} />
                            </span>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <p class="mt-2 text-sm text-lime-500 dark:text-lime-400">Start new chat</p>
                        </div>
                        <div className='flex flex-col items-center'>
                            <span class="inline-block p-3 text-lime-500 rounded-full bg-lime-100/80 dark:bg-gray-800">
                            ...
                            <p class="mt-2 text-sm text-lime-500 dark:text-lime-400">100 Smith Street Collingwood VIC 3066 AU</p>
                        </div>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <p class="mt-2 text-sm text-lime-500 dark:text-lime-400">+1 (555) 000-0000</p>
                        </div>
                    </div>
        {/* Contact Form */}
                        ...
                        <form>
                            <div class="-mx-2 md:items-center md:flex">
                                <div class="flex-1 px-2">
                                    ...
                                    <input type="text" placeholder="Joel " class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-lime-400 dark:focus:border-lime-400 focus:ring-lime-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                                <div class="flex-1 px-2 mt-4 md:mt-0">
                                    <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Last Name</label>
                                    <input type="text" placeholder="Joshua" class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-lime-400 dark:focus:border-lime-400 focus:ring-lime-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>
                            </div>
                            ...
                            <div class="w-full mt-4">
                                ...
                                <textarea class="block w-full h-32 px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-lime-400 dark:focus:border-lime-400 focus:ring-lime-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
                            </div>
